...
from ember.style.state import ToggleState
...
class ToggleStyle(Style):
    _ELEMENT = ToggleButton

    @staticmethod
    def default_state_func(toggle: "ToggleButton") -> ToggleState:
        if toggle._disabled:
    ...
    def __init__(
        ...
        state_func: Callable[["ToggleButton"], "ToggleState"] = default_state_func,
    ):
        ...
        self.state_func: Callable[["ToggleButton"], "ToggleState"] = state_func
        """
